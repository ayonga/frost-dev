...
%% This is z position of end effector    
    ...
    addNodeConstraint(nlp, p_z_func, {'x'}, n_node, 0.17, 0.18, 'Nonlinear');
...
%     normal_vector_to_spatula_x = R_vec_spatula(1);
%     normal_vector_to_spatula_y = R_vec_spatula(2);
%     normal_vector_to_spatula_z = R_vec_spatula(3);
