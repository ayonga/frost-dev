...
%             % domain objects
%             deliver_cooked_burger = FlippyDeliverCookedBurger(model);
            ...
            obj = addVertex(obj, 'FlippyPickBurger', 'Domain', pick_burger, ...
                'Control', io_control);
            obj = addVertex(obj, 'FlippyFlipPlaceBurger', 'Domain', flip_place_burger, ...
                'Control', io_control);
%             obj = addVertex(obj, 'flip_place_burger', 'Domain', flip_place_burger, ...
%                 'Control', io_control);
            
            srcs = {'FlippyPickBurger'
                'FlippyFlipPlaceBurger'};
        ...
        function obj = loadParam(obj, param_config_file, model)
            ...
            obj = setVertexProperties(obj, 1:2, 'Param',...
                params);
