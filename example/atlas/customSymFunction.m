function customSymFunction(plant, export_path)
...
index = plant.Gamma.Nodes.Domain{1}.ActPositionOutput.getIndex('RightTorsoRoll');
kin_obj = plant.Gamma.Nodes.Domain{1}.ActPositionOutput.KinGroupTable(index).KinObj;
...
index = plant.Gamma.Nodes.Domain{2}.ActPositionOutput.getIndex('LeftLegRoll');
kin_obj = plant.Gamma.Nodes.Domain{2}.ActPositionOutput.KinGroupTable(index).KinObj;
...
legRollBoundary = setDescription(legRollBoundary,'boundary constraints on right torso roll output');
