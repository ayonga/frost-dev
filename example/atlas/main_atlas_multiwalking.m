...
% compile(left_toe_strike_relabel, atlas, true);
% export(left_toe_strike_relabel, export_path, true);
% atlas_multiwalk = addEdge(atlas_multiwalk, 'RightHeelStrike', 'RightToeStrike', 'Guard', left_toe_strike_relabel);
% atlas_multiwalk = rmVertex(atlas_multiwalk, {'LeftToeStrike', 'LeftToeLift', 'LeftHeelStrike'});
