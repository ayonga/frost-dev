function [base_dofs] = GetCustumBase()
    ...
    [limit(1:6).lower] = deal(-10, -10, 0.25, -.02, -.02, -0.01);
    [limit(1:6).upper] = deal(10, 10, 2, .02, .02, 0.01);
    [limit(1:6).velocity] = deal(20, 20, 20, 0.1, 0.5, 0.1);
