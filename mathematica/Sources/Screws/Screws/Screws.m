...
CrossProd::usage="CrossProd[R]  
Extracts the cross product vector form which is dual to the passed skew-symmetric matrix.";
...
CrossProd[R_?MatrixQ]:={R[[3,2]],R[[1,3]],R[[2,1]]};
